...
export function SingleSelect({
	...
	return (
		...
		>
			...
			{value && (
				<button
					className='absolute top-0 -right-4 opacity-30 hover:opacity-100 transition-opacity'
					onClick={e => {
						e.preventDefault()
						onChange('')
					}}
			...
			{isShow && (
				<div
					className={cn(
						'absolute w-full p-2.5 left-0 slide bg-colors-sidebar z-10 shadow rounded-lg'
					)}
					style={{
						top: 'calc(100% + .5rem)'
					}}
