...
export function Pomodoro() {
	...
	const { isPending, createSession } = useCreateSession()
	...
	return (
		<div className='relative w-80 text-center'>
			{!isLoading && (
				<div className='text-[100px] font-semibold'>
			...
			{isLoading ? (
				...
				<button
					...
					className='mt-1 p-2 bg-purple-500 hover:bg-purple-500/60 transition rounded-md'
					disabled={isPending}
				>
					Create session
				</button>
